  ...
  return (
    <div className="min-h-dvh grid grid-rows-[1fr_auto]">
      ...
      <main className="pt-0">
        {/* Hero */}
        <section
          className="relative overflow-hidden min-h-[100svh] bg-white"
          role="banner"
        >
          {/* Content */}
          <div className="mx-auto max-w-[980px] px-4 sm:px-6 min-h-[100svh] flex flex-col items-center justify-center text-center relative z-10">
            ...
            <FadeInUp delay={0.2}>
              <h1 className="font-sans text-4xl sm:text-5xl md:text-6xl leading-[1.06] tracking-[-0.02em] text-slate-900 mb-4 font-normal [text-wrap:balance]">
                ...
                <span className="ml-2 align-baseline whitespace-nowrap rounded-md bg-rose-100/80 px-2 py-0.5 border border-rose-200 text-slate-900 shadow-[0_1px_0_rgba(0,0,0,0.02)]">
                  doomscrolling
                </span>
              </h1>
            </FadeInUp>
            ...
            <FadeInUp delay={0.3}>
              <p className="mx-auto max-w-[60ch] text-[16px] leading-[1.7] text-slate-700/90 font-normal mb-7">
                Set gentle limits, add intentional friction, and focus on what
                matters.
        ...
        <section
          id="features"
          className="border-t border-slate-200/80 bg-white scroll-mt-24"
        >
            ...
            <FadeInUp delay={0.2} className="order-1 lg:order-2">
              <div>
                ...
                <div className="border border-slate-200 bg-white/90 backdrop-blur-sm p-6 shadow-sm hover:shadow-md transition-shadow max-w-[560px] rounded-2xl">
                  <div className="text-[13px] text-black/60 mb-3">
                    On a feed… (12m elapsed)
                  </div>
                  <div className="border border-slate-200 bg-white p-5 text-left rounded-xl shadow-sm">
                    <div className="font-serif-display text-2xl leading-tight tracking-[-0.01em]">
                      Time for a short break?
                    </div>
                    <p className="mt-2 text-[14px] text-black/70">
                      Stand up, breathe, grab water—then return with intention.
                    </p>
                    <div className="mt-4 flex gap-3">
                      <button className="px-3 py-2 text-[14px] font-medium bg-[var(--accent)] text-white hover:opacity-90 transition-colors rounded-md">
                        Take 2 minutes
                      </button>
                      <button className="px-3 py-2 text-[14px] font-medium border border-slate-200 bg-white hover:bg-slate-50 transition-colors rounded-md">
                        Remind me later
                      </button>
                    </div>
                  </div>
        ...
        <section id="how" className="bg-white scroll-mt-24">
          <div className="mx-auto max-w-[1120px] px-4 sm:px-6 py-16 sm:py-24">
            <FadeInUp>
              <h2 className="text-xl font-semibold mb-6 tracking-[-0.01em]">
                How it works
              </h2>
            </FadeInUp>
              ...
              {[
                {
                  n: 1,
                  t: "Install",
                  d: "Add Reelax from the Chrome Web Store.",
                },
                {
                  n: 2,
                  t: "Set threshold",
                  d: "Use the default or pick when the overlay should appear.",
                },
                {
                  n: 3,
                  t: "Take mindful breaks",
                  d: "When prompted, step away briefly and return with intention.",
                },
              ].map((s, index) => (
                <FadeInUp key={s.n} delay={index * 0.2}>
                  <li className="border border-slate-200 bg-white p-5 rounded-xl shadow-sm hover:shadow-md transition-shadow duration-300 h-full flex flex-col">
                    ...
                    <p className="mt-1 text-[14px] leading-[1.6] text-black/80 font-medium flex-1">
                      {s.d}
                    </p>
                  </li>
                </FadeInUp>
          ...
          <div className="mx-auto max-w-[900px] px-4 sm:px-6 py-16 sm:py-24">
            ...
            <FadeInUp delay={0.2}>
              <FAQSectionClient
                items={[
                  {
                    q: "Will this block everything?",
                    a: "No. Reelax adds friction and limits, but you stay in control. You can pause or allowlist when needed.",
                  },
                  {
                    q: "Does it work on mobile?",
                    a: "Reelax is a desktop Chrome extension. Mobile support is on the roadmap via iOS/Android browsers that support extensions.",
                  },
                  {
                    q: "Is my data tracked?",
                    a: "No. Settings are stored locally in your browser. We do not collect browsing data.",
                  },
                ]}
              />
            </FadeInUp>
          ...
          <div className="flex flex-col sm:flex-row items-start justify-between gap-6">
            <div className="space-y-2">
              <div className="flex items-center gap-2 select-none">
                <div
                  className="size-4 border border-slate-300 bg-white"
                  aria-hidden
                />
                <span className="font-medium">Reelax</span>
              </div>
              <p className="text-[13px] text-black/60 max-w-[48ch]">
                Mindful breaks for endless feeds. Minimalist overlay. No complex
                setup.
              </p>
            </div>
            <div className="flex flex-col sm:items-end gap-3">
              ...
              <a
                href="#cta"
                className="inline-flex px-3 py-1.5 text-[13px] font-medium rounded-md bg-[var(--accent)] text-white shadow-sm hover:opacity-90 transition-all duration-200"
              >
                Add to Chrome
              </a>
            </div>
