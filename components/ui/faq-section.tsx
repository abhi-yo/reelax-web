        ...
        <div className="container">
          ...
          {contactInfo && (
            <motion.div
              ...
              className="max-w-md mx-auto mt-12 p-6 rounded-lg text-center border border-border/50"
            >
              <div className="inline-flex items-center justify-center p-1.5 rounded-full mb-4 bg-muted text-foreground">
